...
const CategoryPage = () => {
   ...
   const renderGenres = () => {
      return (
         ...
         genres.map((genre: any, index: number) => {
            return (
               <div key={genre.name} className={`flex flex-row flex-wrap w-1/2 bg-white cursor-pointer hover:bg-gray-100`}>
   ...
   return (
      <>
         ...
         <div className={'flex flex-row flex-wrap w-full bg-white '}>{renderGenreStatus()}</div>
      </>
   );
};
