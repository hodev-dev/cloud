...
const HomePage = () => {
        ...
        if (lastPage === currentPage) {
            return (
                <div
                    onClick={handleMore}
                    className={
                        'flex flex-row items-center justify-center w-full h-16 cursor-pointer hover:bg-gray-200'
                    }
                >
        ...
        if (gameStatus === GameStatus.LOADING) {
            ...
            return games.map((game: any) => {
                return (
                    <div
                        key={game.name}
                        className={'flex flex-wrap w-1/6 h-auto rounded-2xl'}
                        dir={'rtl'}
                    >
                        <div
                            key={'img1'}
                            className={
                                'relative flex flex-col w-full h-auto bg-white shadow-sm cursor-pointer'
                            }
                            dir={'rtl'}
                        >
                            <div
                            ...
                            <div
                                ...
                                className={
                                    'absolute top-0 flex items-end justify-center w-full opacity-100 h-96 '
                                }
                            >
                                <h1
                                    className={
                                        'p-4 font-medium text-center text-white text-md'
                                    }
                                >
                                    {game.name}
                                </h1>
            ...
            return (
                <div
                    className={
                        'flex flex-row items-center justify-center w-full h-screen'
                    }
                >
    ...
    return (
        <>
            ...
            <div
                className={
                    'relative flex flex-row flex-wrap w-full h-auto bg-white'
                }
            >
                {renderGames()}
            </div>
