...
class AddGame implements ShouldQueue
{
    ...
    public function add_screenshots($id)
    {
        ...
        foreach ($screenshots['results'] as $index => $screenshot) {
            ...
            $optimized_image = (string) $new_image->resize(1920, 1080)->encode();
    ...
    {
        $games_detail = Http::retry(100, 1000)->get("https://api.rawg.io/api/games?key=a8175a54c4164e2ebb75d41fe6fba77b".$id);
